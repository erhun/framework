...
public class MybatisConfigurationImpl extends Configuration {
    ...
    public MybatisConfigurationImpl(Configuration configuration) {
    ...
    protected void buildAllStatements() {
        ...
        try {
           Method method = configuration.getClass().getMethod("buildAllStatements");
    ...
    protected String extractNamespace(String statementId) {
        try {
            Method method = configuration.getClass().getMethod("extractNamespace", String.class);
            method.setAccessible(true);
            return (String) method.invoke(configuration, statementId);
        } catch (NoSuchMethodException e) {
            e.printStackTrace();
        } catch (IllegalAccessException e) {
            e.printStackTrace();
    ...
    protected void checkGloballyForDiscriminatedNestedResultMaps(ResultMap rm) {
        try {
            Method method = configuration.getClass().getMethod("checkGloballyForDiscriminatedNestedResultMaps", ResultMap.class);
            method.setAccessible(true);
            method.invoke(configuration, rm);
        } catch (NoSuchMethodException e) {
            e.printStackTrace();
        } catch (IllegalAccessException e) {
            e.printStackTrace();
    ...
    protected void checkLocallyForDiscriminatedNestedResultMaps(ResultMap rm) {
        try {
            Method method = configuration.getClass().getMethod("checkLocallyForDiscriminatedNestedResultMaps", ResultMap.class);
            method.setAccessible(true);
            method.invoke(configuration, rm);
        } catch (NoSuchMethodException e) {
            e.printStackTrace();
