...
public class Node <T> implements Serializable {
    ...
    public Node(String id, String name, String value, String type) {
        this.id = id;
        this.type = type;
        this.name = name;
        this.value = value;
    ...
    public Node(String id, String code, String name, String type, String value, String url, String icon, String showMode) {
        this.id = id;
        this.code = code;
        this.name = name;
        this.type = type;
